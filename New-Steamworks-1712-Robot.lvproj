...
AddOutputFilter chunkFilter
		...
		<Item Name="Drive VIs" Type="Folder">
			<Item Name="GetDriveRefnums.vi" Type="VI" URL="../GetDriveRefnums.vi"/>
			<Item Name="DriveMotors.vi" Type="VI" URL="../DriveMotors.vi"/>
			<Item Name="SetDriveTank.vi" Type="VI" URL="../SetDriveTank.vi"/>
			<Item Name="SetDriveArcade.vi" Type="VI" URL="../SetDriveArcade.vi"/>
		</Item>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="user.lib" Type="Folder">
				<Item Name="Z900_navX_Flags_OpStatusTypeDef.ctl" Type="VI" URL="/&lt;userlib&gt;/navX/_TypeDefs/Flags/Z900_navX_Flags_OpStatusTypeDef.ctl"/>
				<Item Name="Z900_navX_Flags_CalibrationStatusTypeDef.ctl" Type="VI" URL="/&lt;userlib&gt;/navX/_TypeDefs/Flags/Z900_navX_Flags_CalibrationStatusTypeDef.ctl"/>
				<Item Name="Z900_navX_Flags_SelfTestStatusTypeDef.ctl" Type="VI" URL="/&lt;userlib&gt;/navX/_TypeDefs/Flags/Z900_navX_Flags_SelfTestStatusTypeDef.ctl"/>
				<Item Name="NavX Main.vi" Type="VI" URL="/&lt;userlib&gt;/navX/NavX Main.vi"/>
				<Item Name="FRIC_navX_Internal_I2C_ProcessingLoop.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Processing Loop/FRIC_navX_Internal_I2C_ProcessingLoop.vi"/>
				<Item Name="FRIC_navX_I2C Process Loop TypeDef.ctl" Type="VI" URL="/&lt;userlib&gt;/navX/_TypeDefs/FRIC_navX_I2C Process Loop TypeDef.ctl"/>
				<Item Name="FRIC_navX_ProcessingLoopStatesTypeDef_I2C.ctl" Type="VI" URL="/&lt;userlib&gt;/navX/_TypeDefs/FRIC_navX_ProcessingLoopStatesTypeDef_I2C.ctl"/>
				<Item Name="Z900_navX_DeviceTypeDef.ctl" Type="VI" URL="/&lt;userlib&gt;/navX/_TypeDefs/Z900_navX_DeviceTypeDef.ctl"/>
				<Item Name="Z900_navX_ProtocolTypeDef.ctl" Type="VI" URL="/&lt;userlib&gt;/navX/_TypeDefs/Z900_navX_ProtocolTypeDef.ctl"/>
				<Item Name="Z900_navX_IntegrationControlRegisters.ctl" Type="VI" URL="/&lt;userlib&gt;/navX/_TypeDefs/Z900_navX_IntegrationControlRegisters.ctl"/>
				<Item Name="Z900_navX_Flags_CapabilityTypeDef.ctl" Type="VI" URL="/&lt;userlib&gt;/navX/_TypeDefs/Flags/Z900_navX_Flags_CapabilityTypeDef.ctl"/>
				<Item Name="FRIC_navX_Internal_ProcessingLoop_AddToArray.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Processing Loop/FRIC_navX_Internal_ProcessingLoop_AddToArray.vi"/>
				<Item Name="FRIC_navX_Internal_I2C_GenerateCommand.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Processing Loop/FRIC_navX_Internal_I2C_GenerateCommand.vi"/>
				<Item Name="Z900_navX_ZeroVectorTypeDef.ctl" Type="VI" URL="/&lt;userlib&gt;/navX/_TypeDefs/Z900_navX_ZeroVectorTypeDef.ctl"/>
				<Item Name="FRIC_navX_Get_NextState_ProcessLoop.vi" Type="VI" URL="/&lt;userlib&gt;/navX/Get/_Internal/FRIC_navX_Get_NextState_ProcessLoop.vi"/>
				<Item Name="Get_Error_Status.vi" Type="VI" URL="/&lt;userlib&gt;/navX/Get/Get_Error_Status.vi"/>
				<Item Name="Get_Connect_Status.vi" Type="VI" URL="/&lt;userlib&gt;/navX/Get/Get_Connect_Status.vi"/>
				<Item Name="Get_STREAM_TYPE.vi" Type="VI" URL="/&lt;userlib&gt;/navX/Get/Get_STREAM_TYPE.vi"/>
				<Item Name="Get_Notifier_Hault_Notifier.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Processing Loop/Get_Notifier_Hault_Notifier.vi"/>
				<Item Name="Get_HaultStatus.vi" Type="VI" URL="/&lt;userlib&gt;/navX/Get/Get_HaultStatus.vi"/>
				<Item Name="FRIC_navX_Internal_ProcessingLoop_UpdateAE.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Processing Loop/FRIC_navX_Internal_ProcessingLoop_UpdateAE.vi"/>
				<Item Name="Z900_navX_Flags_HardwareRevTypeDef.ctl" Type="VI" URL="/&lt;userlib&gt;/navX/_TypeDefs/Flags/Z900_navX_Flags_HardwareRevTypeDef.ctl"/>
				<Item Name="Z900_navX_Flags_OmnimountConfigTypeDef.ctl" Type="VI" URL="/&lt;userlib&gt;/navX/_TypeDefs/Flags/Z900_navX_Flags_OmnimountConfigTypeDef.ctl"/>
				<Item Name="Get_Timestamp.vi" Type="VI" URL="/&lt;userlib&gt;/navX/Get/Get_Timestamp.vi"/>
				<Item Name="FRIC_navX_Util_DecodeProtocol_UInt32.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Util/Decode/FRIC_navX_Util_DecodeProtocol_UInt32.vi"/>
				<Item Name="FRIC_navX_Get_RawValues_GyroAccelMag.vi" Type="VI" URL="/&lt;userlib&gt;/navX/Get/_Raw Values/FRIC_navX_Get_RawValues_GyroAccelMag.vi"/>
				<Item Name="Get_BoardInformation.vi" Type="VI" URL="/&lt;userlib&gt;/navX/Get/Get_BoardInformation.vi"/>
				<Item Name="Get_MPUTemp.vi" Type="VI" URL="/&lt;userlib&gt;/navX/Get/Get_MPUTemp.vi"/>
				<Item Name="Get_Displacement.vi" Type="VI" URL="/&lt;userlib&gt;/navX/Get/Get_Displacement.vi"/>
				<Item Name="FRIC_navX_DecodeRegisterLengthClusterTypeDef_.ctl" Type="VI" URL="/&lt;userlib&gt;/navX/_TypeDefs/FRIC_navX_DecodeRegisterLengthClusterTypeDef_.ctl"/>
				<Item Name="FRIC_navX_Util_DecodeProtocol_Int32.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Util/Decode/FRIC_navX_Util_DecodeProtocol_Int32.vi"/>
				<Item Name="Get_Quaternion.vi" Type="VI" URL="/&lt;userlib&gt;/navX/Get/Get_Quaternion.vi"/>
				<Item Name="FRIC_navX_Internal_SPI_ProcessingLoop.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Processing Loop/FRIC_navX_Internal_SPI_ProcessingLoop.vi"/>
				<Item Name="FRIC_navX_Internal_SPI_GenerateCommand.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Processing Loop/FRIC_navX_Internal_SPI_GenerateCommand.vi"/>
				<Item Name="navX_SPI_CRC.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Device/_Internal/SPI/navX_SPI_CRC.vi"/>
				<Item Name="FRIC_navX_Internal_Serial_ProcessingLoop.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Processing Loop/FRIC_navX_Internal_Serial_ProcessingLoop.vi"/>
				<Item Name="Z900_navX_SERIAL_DecodePacket.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Device/_Internal/SERIAL/Z900_navX_SERIAL_DecodePacket.vi"/>
				<Item Name="Z900_navX_Util_EncodeProtocol_UnsignedHundredths.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Util/Encode Protocol/Z900_navX_Util_EncodeProtocol_UnsignedHundredths.vi"/>
				<Item Name="Z900_navX_Util_EncodeProtocol_Int16.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Util/Encode Protocol/Z900_navX_Util_EncodeProtocol_Int16.vi"/>
				<Item Name="Z900_navX_Util_BigEndian_to_LittleEndian.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Util/Z900_navX_Util_BigEndian_to_LittleEndian.vi"/>
				<Item Name="Z900_navX_Util_EncodeProtocol_SignedHundredths.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Util/Encode Protocol/Z900_navX_Util_EncodeProtocol_SignedHundredths.vi"/>
				<Item Name="Z900_navX_Util_EncodeProtocol_UInt16.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Util/Encode Protocol/Z900_navX_Util_EncodeProtocol_UInt16.vi"/>
				<Item Name="Z900_navX_SERIAL_CapturePacket.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Device/_Internal/SERIAL/Z900_navX_SERIAL_CapturePacket.vi"/>
				<Item Name="Z900_navX_SERIAL_ValidatePacketChecksum.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Device/_Internal/SERIAL/Z900_navX_SERIAL_ValidatePacketChecksum.vi"/>
				<Item Name="Z900_navX_SERIAL_ValidatePacketTermination.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Device/_Internal/SERIAL/Z900_navX_SERIAL_ValidatePacketTermination.vi"/>
				<Item Name="FRIC_navX_Clear_Buffer_Warning.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Processing Loop/FRIC_navX_Clear_Buffer_Warning.vi"/>
				<Item Name="FRIC_navX_Internal_Serial_GenerateCommand.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Processing Loop/FRIC_navX_Internal_Serial_GenerateCommand.vi"/>
				<Item Name="Z900_navX_SERIAL_PacketChecksum.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Device/_Internal/SERIAL/Z900_navX_SERIAL_PacketChecksum.vi"/>
				<Item Name="Update Serial Stream.vi" Type="VI" URL="/&lt;userlib&gt;/navX/Set/Update Serial Stream.vi"/>
				<Item Name="FRIC_navX_Internal_USB_ProcessingLoop.vi" Type="VI" URL="/&lt;userlib&gt;/navX/_Processing Loop/FRIC_navX_Internal_USB_ProcessingLoop.vi"/>
			</Item>
